...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.bongole.ti.social.js')
	...
	f = os.path.join(cwd,'Classes','ComBongoleTiSocialModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.bongole.ti.social.js']
